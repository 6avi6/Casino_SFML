...
SelectedButton::SelectedButton(const sf::Vector2f& position,const sf::Vector2f& size,const sf::Color& color,const std::string& text,const sf::Font& font,const int& value)
: isSelected(false), value(value)
{
    ...
    buttonText.setFillColor(sf::Color(255 - color.r, 255 - color.g, 255 - color.b));
...
void SelectedButton::update()
{
    ...
    if (isSelected) {
        sf::Color newColor(currentColor.r, currentColor.g, currentColor.b, 100); 
        shape.setFillColor(newColor);
    }
    else {
        sf::Color newColor(currentColor.r, currentColor.g, currentColor.b, 255);  
        shape.setFillColor(newColor);
    }
}
